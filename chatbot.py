...
os.environ["OPENAI_API_KEY"] = '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'
openai.api_key = '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' # Setting your API key
...
response = logic("Who designed the first computer?") # Passing the question to the ChatBot
